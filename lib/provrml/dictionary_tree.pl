...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- pred select_branch(+Direction,+TreeIn,-TreeOut)
   :: atm * tree * tree
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- pred change_direction(+Key,+TreeIn,-TreeOut)
   :: atm * tree * tree
