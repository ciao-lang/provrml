...
create_environment(parse(_,env(_,_,W),_),'PROTO',Name,env('PROTO',Name,W)).
create_environment(parse(_,env(_,_,W),_),'EXTERNPROTO',Name,
               env('EXTERNPROTO',Name,W)).
create_environment(parse(_,env(_,_,W),_),'DEF',Name,env('DEF',Name,W)).
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- pred set_dictionaries(+Dic,+Parse,-NewParse) 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- pred push_dictionaries(+Trash,+In,-Out)
   :: parse * parse * parse
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- pred set_whitespace_row(+Row,+OldWhitespace,-Whitespace)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- pred set_indentation(+Ind,+OldWhitespace,-Whitespace)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- pred look_ahead(+Name,+ParsedIn,-ParsedOut)
