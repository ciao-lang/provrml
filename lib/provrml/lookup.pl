...
lookup_get_fieldType(_Parse_struct, NodeTypeId, FieldId, FieldType) :-
    dictionary(NodeTypeId, _FieldAccess, FieldType,FieldId, _InitValue, _Boundaries),
    !.
...
lookup_get_fieldType(Parse_struct, NodeTypeId, FieldId, FieldType) :-
    ...
    ( Name == 'Script' ->
        ...
        ( StatInter == defined -> true
        ;  error_vrml(fieldType_undefined(NodeTypeId,FieldId))
        )
    ; dictionary(Name, _FieldAccess, FieldType, FieldId, _InitValue, _Boundaries)
    ).
lookup_get_fieldType(Parse_struct, NodeTypeId, FieldId, FieldType) :-
    get_dictionaries(Parse_struct,Dic),
    get_prototype_dictionary(Dic,Proto_dic),
...
lookup_field(In,NodeTypeId0, FieldId0,FieldId1) :-
    dictionary(NodeTypeId0, _, FieldType0, FieldId0, _InitValue, _Boundaries),
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- pred lookup_field_access(+Parse, +NodenameId, +FieldId0, +FieldId1)
   :: parse * atm * atm * atm
...
lookup_field_access(Parse_struct, NodeName0, FieldId0, FieldId1) :-
    ...
    (Status == defined ->
        ...
        FieldType0 == FieldType1
    ; error_vrml(accessType(NodeName0,FieldId0,Acc0,NodeName1,FieldId1,Acc1))
    ).
lookup_field_access(Parse_struct, NodeName0, FieldId0, FieldId1) :-
    get_dictionaries(Parse_struct,Dic),
    get_prototype_dictionary(Dic,Proto_dic),
...
lookup_access(In, NodeTypeId, FieldId, Acc) :-
    ...
    ;
    dictionary(Name, Acc, _FieldType, FieldId, _InitValue, _Boundaries)
    ).
lookup_access(In,NodeTypeId,FieldId,Acc) :-
    get_dictionaries(In,Dic),
    get_prototype_dictionary(Dic,Proto_dic),
